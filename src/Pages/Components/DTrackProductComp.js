...
function DTrackProductComp() {
    ...
    async function retrievePackage(orderCode) {


        let requestPackage = {
            method: 'GET',
            url: process.env.REACT_APP_BACKENDURL + '/api/getPackage/' + orderCode,
            headers: {
        ...
        setPackageDetails(JSON.parse(responsePackage.data[0].order_product));
...
export default DTrackProductComp
