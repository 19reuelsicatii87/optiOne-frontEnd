...
function DistributorMember() {
    return (
        <section id="distrubutor-member">
            <div className="container">
                <div className="row my-5">
                    <h1 className="text-start text-primary py-3" >HOW TO BECOME A DISTRIBUTOR | MEMBER</h1>

                    <div className="col-md-7" style={{ height: "600px" }}>
                        <iframe width="100%" height="100%"
                            title="6rqf8-iEyAM"
                            src="https://www.youtube.com/embed/2e2r5-s_JBA?autoplay=1&controls=1&loop=0&mute=1&rel=0&start=0">
                        </iframe>
                    </div>
                        ...
                        <div id="promotion-card">
                            ...
                            <div id="promotion-card-body">
                                ...
                                <p className="text-start">When it comes to creating an income and building a business - that is
                                    totally up to you. We offer the resources needed, and foundation upon
                                    which you can build a part-time or full-time livelihood. You decide.
                                    You are in control of your financial wellness, as well as your mindset
